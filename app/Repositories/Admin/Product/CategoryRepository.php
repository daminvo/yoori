...
//            $category->is_digital        = $request->is_digital;
    ...
    {
        return Category::with('childCategories')->where('parent_id',null)->where('status',1)->orderBy('ordering')->latest()->take(10)->get();
    }
    ...
    public function categoryProducts($id)
    {
        ...
        if ($category)
        {
            ...
            $products =  Product::with('productLanguages')->whereIn('category_id',$category_ids)
