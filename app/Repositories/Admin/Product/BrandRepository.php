...
class BrandRepository implements BrandInterface
{
    ...
    {
        return Brand::with('currentLanguage')->active()->latest()->paginate(5);
    }

    public function allBrands()
    {
        return Brand::with('currentLanguage')->active()->latest()->paginate(30);
    }

    public function homePageBrands()
    {
        return Brand::with('currentLanguage')->select('id','logo','slug')->where('status',1)->take(10)->get();
    }

    public function brand($slug)
    {
        $brand =  Brand::with('currentLanguage')->where('slug',$slug)->first();
        return $brand->makeHidden(['banner','logo']);
    }
