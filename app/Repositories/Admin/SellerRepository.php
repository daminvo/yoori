...
class SellerRepository implements SellerInterface
{
    ...
    {
        $sellers = SellerProfile::select('id','logo','slug','user_id','shop_name','reviews_count','rating_count','logo','banner')->whereHas('products',function ($q){
    ...
    {
        $sellers = SellerProfile::select('id','logo','slug','user_id','shop_name','reviews_count','rating_count','logo','banner')->with(['products' => function($q){
            $q->ProductPublished();
    ...
    {
        $sellers = SellerProfile::select('id','logo','slug','user_id','shop_name','reviews_count','rating_count','logo','banner')->whereIn('user_id',$ids)->Available()->get();
        return $sellers->makeHidden(['logo','banner']);
    }
    ...
    {
        return SellerProfile::Available()->latest()->paginate($limit);
    }
    public function bestShop($limit){
        return SellerProfile::select('id','logo','slug','user_id','shop_name','reviews_count','rating_count','logo','banner')->with(['products' => function($q){
            $q->ProductPublished();
            }])
            ->orderBy('rating_count','desc')
            ->Available()
    ...
    public function topShop($limit){
        return SellerProfile::select('id','logo','slug','user_id','shop_name','reviews_count','rating_count','logo','banner')
