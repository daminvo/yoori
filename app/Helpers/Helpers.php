...
if (!function_exists('get_account_info')) {
    ...
    if (!function_exists('getFileLink')) {
        function getFileLink($size, $array)
        {
        ...
        function mail_config()
        {
            ...
            if ($mail_driver)
            {
                ...
                elseif($mail_driver == 'sendgrid'):
                    $mail_host                 = settingHelper('title', 'sendgrid_mail_host');
                    $mail_port                 = settingHelper('title', 'sendgrid_mail_port');
                    $mail_address              = settingHelper('title', 'sendgrid_mail_address');
                    $name                      = settingHelper('title', 'sendgrid_name');
                    $mail_username             = settingHelper('title', 'sendgrid_mail_username');
                    $mail_password             = settingHelper('title', 'sendgrid_mail_password');
                    $mail_encryption_type      = settingHelper('title', 'sendgrid_mail_encryption_type');
...
//                                'port'          => 25,
    ...
    if (!function_exists('update_version')):
        ...
        {
            if (settingHelper('current_version') == '1.0.0' || settingHelper('current_version') < 132):
