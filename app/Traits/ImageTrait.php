...
trait ImageTrait
{
    public function saveImage($requestImage, $for = '_product_', $save_to_db = false)
    {
        if (!empty($requestImage) && $requestImage != 'null') :
            ...
            if ($for == 'favicon'):
                ...
                Image::make($requestImage)->resize(640, 1136,
                    ...
                    ->resizeCanvas(640, 1136, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_640x1136_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(750, 1334,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(750, 1334, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_750x1334_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1242, 2208,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1242, 2208, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1242x2208_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1125, 2436,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1125, 2436, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1125x2436_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1125, 2436,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                ...
                Image::make($requestImage)->resize(828, 1792,
                    ...
                    ->resizeCanvas(828, 1792, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_828x1792_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1242, 2688,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1242, 2688, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1242x2688_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1536, 2048,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1536, 2048, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1536x2048_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1668, 2224,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1668, 2224, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1668x2224_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(1668, 2388,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(1668, 2388, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_1668x2388_url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(2048, 2732,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(2048, 2732, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$splash_2048x2732_url, $encode_percentage, 'webp');
            ...
            elseif ($for == 'admin_light_logo' || $for == 'admin_dark_logo' || $for == 'footer_logo' || $for == 'invoice_logo' ||
                ...
                if ($for == 'admin_light_logo' || $for == 'admin_dark_logo'):
                    ...
                    Image::make($requestImage)->fit(100, 38)->save('public/'.$image_100x38_url, $encode_percentage, 'webp');
                elseif ($for == 'footer_logo'):
                    $image_89x33        = date('YmdHis') . "-" . $for . '-89x33' . rand(1, 500) . '.' . $extension;
                    $image_89x33_url    = $directory . $image_89x33;
                    Image::make($requestImage)->fit(100, 38)->save('public/'.$image_89x33_url, $encode_percentage, 'webp');
                elseif ($for == 'light_logo' || $for == 'dark_logo'):
                    ...
                    Image::make($requestImage)->fit(118, 45)->save('public/'.$image_118x45_url, $encode_percentage, 'webp');
                ...
                elseif ($for == 'payment_method_banner'):
                    ...
                    Image::make($requestImage)->save('public/'.$image_payment_url, $encode_percentage, 'webp');
                elseif ($for == 'service_image'):
                    $image_40x40        = date('YmdHis') . "-" . $for . '-40x40' . rand(1, 50) . '.' . $extension;
                    $image_40x40_url    = $directory . $image_40x40;
                    Image::make($requestImage)->fit(60, 40)->save('public/'.$image_40x40_url, $encode_percentage, 'webp');
                elseif ($for == 'seller_logo'):
                    ...
                    Image::make($requestImage)->fit(197, 152)->save('public/'.$image_197x152_url, $encode_percentage, 'webp');
                    Image::make($requestImage)->fit(320, 320)->save('public/'.$image_320x320_url, $encode_percentage, 'webp');
                    Image::make($requestImage)->fit(120, 80)->save('public/'.$image_120x80_url, $encode_percentage, 'webp');
                    Image::make($requestImage)->fit(82, 82)->save('public/'.$image_82x82_url, $encode_percentage, 'webp');
                ...
                elseif ($for == 'seller_banner'):
                    ...
                    Image::make($requestImage)->fit(617, 145)->save('public/'.$image_617x145_url, $encode_percentage, 'webp');
                    Image::make($requestImage)->fit(297, 203)->save('public/'.$image_297x203_url, $encode_percentage, 'webp');
//                    Image::make($requestImage)->fit(406, 195)->save('public/'.$image_297x203_url, $encode_percentage, 'webp');
                ...
                elseif ($for == 'popup_image'):
                    ...
                    Image::make($requestImage)->resize(270, 260,
                        ...
                        ->resizeCanvas(270, 260, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_270x260_url, $encode_percentage, 'webp');
                endif;
                ...
                Image::make($requestImage)->fit(72, 72)->save('public/'.$imageSmallTwoUrl, $encode_percentage, 'webp');
            ...
            elseif ($for == '_staff_'):
                ...
                Image::make($requestImage)->save('public/'.$originalImageUrl, $encode_percentage);
                Image::make($requestImage)->fit(130, 130)->save('public/'.$imageProfileThumbnailUrl, $encode_percentage, 'webp');
                Image::make($requestImage)->fit(20, 20)->save('public/'.$image20X20Url, $encode_percentage, 'webp');
                Image::make($requestImage)->fit(40, 40)->save('public/'.$image40X40Url, $encode_percentage, 'webp');
            ...
            elseif ($for == 'single_file'):
                ...
                Image::make($requestImage)->save('public/'.$originalImageUrl, $encode_percentage, 'webp');
                ...
                Image::make($requestImage)->resize(110, 122,
                    ...
                    ->resizeCanvas(110, 122, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_110x122_url, $encode_percentage,'webp');
                Image::make($requestImage)->resize(40, 40,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(40, 40, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_40x40_Url, $encode_percentage,'webp');
                Image::make($requestImage)->resize(72, 72,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(72, 72, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_72x72_Url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(190, 230, function ($constraint) {
                    $constraint->aspectRatio();
                }, true)->resizeCanvas(190, 230, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_190x230_Url, $encode_percentage, 'webp');
                Image::make($requestImage->getRealPath())->resize(320, 320,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(320, 320, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_320x320_Url, $encode_percentage, 'webp');
                Image::make($requestImage)->resize(180, 120,
                    function ($constraint) {
                        $constraint->aspectRatio();
                    })
                    ->resizeCanvas(180, 120, 'center', false, 'rgba(255, 255, 255, 0.00)')->save('public/'.$image_thumbnail_Url, $encode_percentage, 'webp');
