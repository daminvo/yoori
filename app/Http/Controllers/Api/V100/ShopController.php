...
class ShopController extends Controller
{
    ...
    public function shop($id, SellerProfileInterface $seller,MediaInterface $media,ProductInterface $product, CouponInterface $coupon)
    {
        try {
            $shop = $seller->get($id);
            $data = [
    ...
    public function shopDetails($id, SellerProfileInterface $seller,MediaInterface $media,ProductInterface $product, CouponInterface $coupon): \Illuminate\Http\JsonResponse
    {
        try {
            $shop = $seller->get($id);
            $data = [
