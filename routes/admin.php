    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                //Mobile Apps
                Route::get('api-setting', [MobileAppsController::class, 'apiSetting'])->name('apis.settings')->middleware('PermissionCheck:api_setting_update');
                ...
                Route::delete('delete/services/{service}', [CommonController::class, 'delete'])->name('services.destroy')->middleware('PermissionCheck:service_delete');
