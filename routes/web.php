...
Route::middleware(['XSS','isInstalled'])->group(function (){
    ...
    Route::get('login/{provider}', [SocialController::class,'redirect'])->where('provider','facebook|twitter|google');
...
//            Route::get('coupon-lists', [UserController::class, 'couponList'])->name('convert.reward.history');
    ...
    Route::post('user/recharge-wallet', [UserController::class, 'walletRecharge'])->name('recharge.wallet');

    Route::get('user/mail-order/{trx_id}', [OrderController::class, 'sendMail']);
    ...
    Route::get('/campaign/{slug}', [HomeController::class, 'index'])->where('path','*');
    ...
    Route::get('/category-blogs/{slug}', [HomeController::class, 'index'])->where('path','*');
    ...
    Route::get('video-shopping/{slug}', [HomeController::class, 'index'])->where('path','*');
    ...
    Route::get('stripe/recharge', [PaymentController::class, 'stripeRecharge']);
    Route::get('stripe/recharge-success', [PaymentController::class, 'stripeRechargeSuccess']);
