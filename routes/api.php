...
Route::prefix('v100')->group(function() {
    Route::middleware(['CheckApiKey'])->group(function () {
        ...
        Route::get('home-screen',[\App\Http\Controllers\Api\V100\HomeController::class,'homePageData']);
...
Route::post('complete-order', [OrderController::class, 'completeOrder'])->name('api.complete.order');
