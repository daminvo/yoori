                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ $route }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    <label for="logo" class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="image">{{ __('Thumbnail') }}</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label for="logo" class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="image">{{ __('Banner') }}</label>
                                    <div class="col-sm-12 col-md-7">
                                        <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                             data-target="#galleryModal" data-dismiss="modal">
