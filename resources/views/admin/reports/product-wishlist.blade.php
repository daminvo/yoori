                                    ...
                                    @foreach($wishlist as $key => $value)
                                        <tr>
                                            ...
                                            <td width="300">
                                                <div class="d-flex">
                                                    <div class="text-left">
                                                        @if ($value->product->thumbnail != [] && @is_file_exists($value->product->thumbnail['image_40x40'], $value->product->thumbnail['storage']))
                                                            <img
                                                                src="{{ get_media($value->product->thumbnail['image_40x40'], $value->product->thumbnail['storage']) }}"
                                                                alt="{{ $value->product->getTranslation('name',\App::getLocale()) }}"
                                                                class="mr-3 rounded">
                                                        @else
                                                            <img
                                                    ...
                                                    <div class="ml-1">{{ $value->product->getTranslation('name',\App::getLocale())}}</div>
                                                </div>
                                            </td>
