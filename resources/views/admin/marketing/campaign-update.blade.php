                                ...
                                <table class="table table-responsive table-bordered table-hover table-md">
                                    ...
                                    @foreach ($campaignByLang->campaign->campaignProducts as $key => $camProduct)
                                        ...
                                        <tr id="row_{{ $camProduct->product_id }}" class="table-data-row">
                                            ...
                                            <td>{{ $camProduct->product->price }}</td>
                                            <td style="width: 20%"><input class="form-control" type="number" step="any" min="0" name="discount_{{$camProduct->product_id}}" value="{{ old("discount_".$camProduct->product_id) ? old("discount_".$camProduct->product_id) : $camProduct->discount }}" required></td>
                                            <td style="width: 10%">
