                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-1">
                                                        ...
                                                        @if(\Cartalyst\Sentinel\Laravel\Facades\Activation::completed($request->user) == true)
                                                            <i class='bx bx-check-circle text-success'></i> {{ $request->user->email }}
                                                        @else
                                                            <i class='bx bx-x-circle text-warning'></i> {{ $request->user->email }}
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $request->payment_method }}</td>
                                            <td>{{ get_price($request->amount) }}</td>
