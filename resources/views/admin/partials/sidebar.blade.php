        ...
        <ul class="sidebar-menu">
                ...
                <li class="nav-item dropdown @yield('pos_services_active')">
                    ...
                    <ul class="dropdown-menu">
                        @if(hasPermission('pos_order'))
                            <li><a class="nav-link" href="{{ route('admin.pos.system') }}">{{ __('POS Utility') }}</a></li>
                        @endif
                        @if(hasPermission('pos_config_update'))
                            <li class="@yield('pos_services')"><a class="nav-link" href="{{ route('admin.pos.config') }}">{{ __('POS Configuration') }}</a></li>
                        @endif
                    </ul>
                </li>
            @endif
            ...
            @if(hasPermission('payment_gateway_read'))
                <li class="@yield('payment-gateway')"><a class="nav-link" href="{{ route('payment.gateway') }}"><i
                                class="bx bx-dollar" aria-hidden="true"></i> <span>{{ __('Payment Gateway') }}</span></a>
                </li>
            @endif
            ...
            @endif
            @if(hasPermission('theme_option_update') || hasPermission('header_content_update') || hasPermission('footer_content_update') || hasPermission('home_page_update') || hasPermission('website_seo_update') || hasPermission('website_popup_update') || hasPermission('custom_css_update') || hasPermission('custom_js_update') || hasPermission('gdpr_update') || hasPermission('slider_read') || hasPermission('service_read') || hasPermission('all_page_read') || hasPermission('login_singup_read'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if(hasPermission('facebook_service_update'))
                            <li class="@yield('facebook_services')">
                                <a class="nav-link"
                                   href="{{ route('settings.facebook.services') }}">{{ __('Facebook Services') }}</a>
                            </li>
                        @endif
            ...
            @endif
            @if(isDemoServer())
                @if(hasPermission('api_setting_update') || hasPermission('android_setting_update') || hasPermission('ios_setting_update') || hasPermission('app_config_update') || hasPermission('ads_config_update') || hasPermission('mobile_app_intro_read'))
                    <li class="nav-item dropdown @yield('mobile_apps')">
                        <a href="javaScript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown"><i
                                    class="bx bxl-flutter"></i><span>{{ __('Mobile App') }}</span></a>
                        <ul class="dropdown-menu">
                            ...
                            @endif
                            @if(hasPermission('app_config_update'))
                                <li class="@yield('app_config_settings_active')"><a class="nav-link"
                                                                                    href="{{ route('app.config.settings') }}">{{ __('App Config') }}</a>
                                </li>
                            @endif
                            @if(hasPermission('ads_config_update'))
                                <li class="@yield('ads_config_settings_active')"><a class="nav-link"
                                                                                    href="{{ route('ads.config.settings') }}">{{ __('Ads Config') }}</a>
                                </li>
                            @endif
                            ...
                            @if(hasPermission('android_setting_update'))
                                <li class="@yield('home_page_setting_active')"><a class="nav-link"
                                                                                  href="{{ route('mobile.home.page') }}">{{ __('Home Page Builder') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
            ...
            <li class="nav-item dropdown @yield('addon_utility')">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="@yield('available_addon_active')"><a class="nav-link"
...
<!--            <li class="@yield('updater')">
            ...
            <li class="@yield('server-info')">
                <a class="nav-link" href="{{ route('admin.server.info') }}">
                    <i class="bx bx-server"></i>
                    <span>{{ __('System/Server Info') }}</span>
                </a>
            </li>
        </ul>
    </aside>
