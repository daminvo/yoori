        ...
        <div class="card-body">
            <ul class="nav nav-pills flex-column">
                ...
                @if(hasPermission('facebook_service_update'))
                    <li class="nav-item"><a href="{{ route('settings.facebook.services') }}" class="nav-link @yield('facebook_services_active')">{{ __('Facebook Pixel') }}</a></li>
                @endif
                @if(hasPermission('google_service_update'))
                    <li class="nav-item"><a href="{{ route('settings.google.services') }}" class="nav-link @yield('google_services_active')">{{ __('Google Service') }}</a></li>
                @endif
