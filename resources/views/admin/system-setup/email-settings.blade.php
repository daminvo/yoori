                                ...
                                <div id="mailgunDiv"
                                    ...
                                    <div class="form-group">
                                        <label for="mailgun_domain"
                                               class="form-control-label">{{ __('Mailgun Domain') }}</label>
                                        <input type="text" name="mailgun_domain"
                                               placeholder="{{ __('Enter mailgun domain') }}"
                                               value="{{ old('mailgun_domain') ? old('mailgun_domain') : (isDemoServer() ? emailAddressMask(settingHelper('mailgun_domain')) : settingHelper('mailgun_domain')) }}"
                                               class="form-control" id="mailgun_domain">
                                        @if ($errors->has('mailgun_domain'))
                                            <div class="invalid-feedback">
                                                <p>{{ $errors->first('mailgun_domain') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label for="mailgun_secret"
                                               class="form-control-label">{{ __('Mailgun Secret') }}</label>
                                        <input type="text" name="mailgun_secret"
                                               placeholder="{{ __('Enter mailgun secret') }}"
                                               value="{{ old('mailgun_secret') ? old('mailgun_secret') : (isDemoServer() ? "pubkey-*****************" : settingHelper('mailgun_secret')) }}"
                                               class="form-control" id="mailgun_secret">
                                        @if ($errors->has('mailgun_secret'))
                                            <div class="invalid-feedback">
                                                <p>{{ $errors->first('mailgun_secret') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
