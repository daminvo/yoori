                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="default_time_zone"
                                                ...
                                                @foreach($timezones as $timezone)
                                                    <option
                                                        value="{{ $timezone->timezone }}" {{ $timeZone == $timezone->timezone ? 'selected' : '' }}>
                                                        (UTC {{ $timezone->gmt_offset > 0 ? '+'.$timezone->gmt_offset : $timezone->gmt_offset }}
                                                        ) {{ $timezone->timezone }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="default_country"
                                                   class="form-control-label">{{ __('Countries') }}</label>
