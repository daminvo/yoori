        ...
        <table class="bd--bottom">
            ...
            @foreach ($order->orderDetails as $index => $orderDetails)
                <tr>
                    ...
                    <td width="15%" style="text-align: right">{{get_price($orderDetails->price)}}</td>
                    <td width="30%"
                        style="text-align: right">{{get_price($orderDetails->price * $orderDetails->quantity )}}</td>
                </tr>
            @endforeach
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>:</td>
                    <td width="29%" style="text-align: right;white-space: nowrap">{{get_price($order->sub_total)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    <td width="30%">{{__('Discount')}}</td>
                    <td>:</td>
                    <td width="29%" style="text-align: right;white-space: nowrap">{{get_price($order->discount)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    ...
                    <td width="29%" width="29"
                        style="text-align: right;white-space: nowrap">{{get_price($order->coupon_discount)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    <td width="30%">{{__('Total Tax')}}</td>
                    <td>:</td>
                    <td width="29%" style="text-align: right;white-space: nowrap">{{get_price($order->tax)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    ...
                    <td>:</td>
                    <td width="29%"
                        style="text-align: right;white-space: nowrap">{{get_price($order->total_amount)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    <td width="30%">{{__('Shipping Cost')}}</td>
                    <td>:</td>
                    <td width="29%" style="text-align: right;white-space: nowrap">{{get_price($order->shipping_cost)}}</td>
                </tr>
                <tr>
                    <td width="40%"></td>
                    ...
                    <td width="1%">:</td>
                    <td width="29%"
                        style="text-align: right;white-space: nowrap">{{get_price($order->total_payable)}}</td>
                </tr>
            </table>
        </div>
