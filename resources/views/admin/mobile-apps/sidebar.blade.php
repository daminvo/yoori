        ...
        <div class="card-body">
            <ul class="nav nav-pills flex-column">
                ...
                @if(hasPermission('app_config_update'))
                    <li class="nav-item"><a href="{{ route('app.config.settings') }}"
                                            class="nav-link @yield('app_config_settings')">{{ __('App Config') }}</a>
                    </li>
                @endif
                @if(hasPermission('ads_config_update'))
                    <li class="nav-item"><a href="{{ route('ads.config.settings') }}"
                                            class="nav-link @yield('ads_config_settings')">{{ __('Ads Config') }}</a>
                    </li>
                @endif
