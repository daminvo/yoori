                    ...
                    <div class="card email-card">
                        ...
                        <div class="col-md-10 middle card-body card-body-paddding">
                            ...
                            <form action="{{ $route }}" method="post"
                                ...
                                <div class="productDiv" style="{{ old('action_type') ? (old('action_type') == 'product' ? '' : 'display:none') : (isset($edit) ? ($edit->action_type == 'product' ? '': 'display:none') : '')}}">
                                    <div class="form-group">
                                        <label for="product_id">{{ __('Action To') }}</label>
                                        <input type="hidden" name="for_mobile" value="for_mobile"/>
                                        <select class="product-by-ajax form-control select2" id ="product_id" name="product_id" aria-hidden="true">
                                            <option value="">{{ __('pto') }}</option>
                                        </select>
                                ...
                                <div  class="categoryDiv" style="{{ old('action_type') ? (old('action_type') == 'category' ? '' : 'display:none')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="filter-categories-by-ajax form-control" name="category_id"  aria-hidden="true" id="category_id">
                                    ...
                                    <div  class="blogDiv" style="{{ old('action_type') ? (old('action_type') == 'blog' ? '' : 'display:none')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="filter-blogs-by-ajax form-control" name="blog_id"  aria-hidden="true" id="blog_id">
                                ...
                                <div class="otherDiv" style="{{( isset($edit) ? ($edit->action_type == 'url' ? 'display:none' : '') :  (old('action_type') == 'url' ? 'display:none' :  '' )) }}">
                                    <div class="form-group">
