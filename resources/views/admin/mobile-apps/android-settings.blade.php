                    ...
                    <div class="card" id="settings-card">
                            ...
                            <form action="{{ route('mobile.apps.settings.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apk_file_url" placeholder="{{ __('APK File URL') }}" value="{{ old('apk_file_url') ? old('apk_file_url') : settingHelper('apk_file_url') }}" class="form-control" id="apk_file_url">
