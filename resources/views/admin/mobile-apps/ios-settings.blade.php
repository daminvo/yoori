                    ...
                    <div class="card" id="settings-card">
                            ...
                            <form action="{{ route('mobile.apps.settings.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ipa_file_url" placeholder="{{ __('iPA File URL') }}" value="{{ old('ipa_file_url') ? old('ipa_file_url') : settingHelper('ipa_file_url') }}" class="form-control" id="ipa_file_url">
