                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                    ...
                                                    <input type="hidden" name="featured_category_banner" value="{{ settingHelper('featured_category_banner')['id'] }}" class="image-selected">
                                                ...
                                                <div class="selected-media-box">
                                                    <div class="mt-4 gallery gallery-md d-flex">
                                                        <div class="selected-media mt-0 m-2" data-id="{{ @settingHelper('featured_category_banner')['id'] }}">
