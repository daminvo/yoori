                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="special_discount" id="special_discount"
                                                           min="0"
                                                           step="any"
                                                           value="{{ old('special_discount') != '' ? old('special_discount') : $product_language->product->special_discount }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="campaign_discount"
                                                           value="{{ old('campaign_discount') != '' ? old('campaign_discount') : (($product_language->productCampaign) ? $product_language->productCampaign->discount : '')}}"
