                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                <tr id="row_{{ $category->id }}" class="table-data-row">
                                    ...
                                    <td>
                                        <div class="ml-1"> <span class="{{ $category->icon != null || $category->icon != '' ? $category->icon : 'mdi mdi-view-dashboard-outline'  }}"></span> {{$title = $category->getTranslation('title', \App::getLocale()) }}</div>
                                    </td>
                                    <td>
                                        <div class="ml-1">
                                        @php
                                    ...
                                    <td>
                                        <label class="custom-switch mt-2 {{ hasPermission('category_update') ? '' : 'cursor-not-allowed' }}">
                                            <input  type="checkbox" value="category-status-change/{{$category->id}}" {{$category->status==1 ? 'checked' : ''}} {{ hasPermission('category_update') ? '' : 'disabled'}} name="custom-switch-checkbox" class="{{  hasPermission('category_update') ? 'status-change' : '' }} custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </td>
                                    <td>
                                        @if(hasPermission('category_update'))
                                        <a href="{{route('edit.categories',$category->id)}}" class="btn btn-outline-secondary btn-circle"
                                           data-toggle="tooltip" title=""
                                           data-original-title="{{ __('Edit') }}"><i class="bx bx-edit"></i></a>
                                        @endif
                                        @if(hasPermission('category_delete'))
                                        <a href="javascript:void(0)" onclick="delete_row('delete/categories/',{{$category->id}})"
                    ...
                    <div class="card-body card-body-paddding">
                        <form method="POST" action="{{route('store.categories')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="ordering" type="number" class="form-control" name="ordering" value="{{old('ordering')}}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="commission" type="number" class="form-control" step="any" name="commission" value="{{old('commission')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group category-icon-selector">
                                    <input type="text" name="icon" id="uip-select-input-value"
                                           value="{{ old('icon') ? old('icon') : '' }}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="meta_description" id="meta_description" value="{{old('meta_description')}}" placeholder="{{__('Description')}}"></textarea>
