                        ...
                        <div class="col-sm-xs-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body col-sm-xs-12">
                                                    ...
                                                    <td width="300">
                                                        <label class="custom-switch mt-2 {{ hasPermission('seller_commission_update') ? '' : 'cursor-not-allowed' }}">
                                                            <input type="checkbox" name="custom-switch-checkbox"
                                                                   ...
                                                                   {{ hasPermission('seller_commission_update') ? '' : 'disabled' }}
                                                                   class="{{ hasPermission('seller_commission_update') ? 'status-change': '' }} custom-switch-input " {{ settingHelper('seller_commission_status') == 1 ? 'checked' : ''}} />
                                                            <span class="custom-switch-indicator"></span>
                                                        </label>
                                                    </td>
                                                </tr>
                                    ...
                                    <div  class=" col-sm-xs-12 {{ settingHelper('category_commission_status') == 1 ? 'd-none' : ''}} {{ settingHelper('seller_commission_status') == 1 ? 'show active' : 'd-none'}}">
