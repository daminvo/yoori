                                    ...
                                    @foreach ($users as $key => $user)
                                        <tr id="row_{{$user->id}}">
                                                ...
                                                <div class="d-flex">
                                                    <figure class="avatar mr-2">
                                                        @if (@$user->sellerProfile->logo != [] && @is_file_exists($user->sellerProfile->logo['image_72x72'],$user->sellerProfile->logo['storage']))
                                                            <img
                                                                src="{{ get_media($user->sellerProfile->logo['image_72x72'],$user->sellerProfile->logo['storage']) }}"
                                                    ...
                                                    <div class="ml-1">
                                                        <a href="{{ route('frontend.shop', $user->sellerProfile->slug) }}"> {{ !blank(@$user->sellerProfile->shop_name) ? $user->sellerProfile->shop_name : '' }}</a>
                                            ...
                                            <td>
                                                ...
                                                {{__('Last Login')}}: {{ $user->last_login != '' ? date('M d, Y h:i a', strtotime($user->last_login)) : '' }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a
                                                        href="{{ route('frontend.shop', $user->sellerProfile->slug) }}"
                                                        class="dropdown-item has-icon"
                                                    ><i class="bx bxs-business"></i> {{ __('Shop') }}</a>
                                                    @endif
                                                    <a href="{{ route('login.by.user', $user->id) }}"
                                                       class="dropdown-item has-icon"><i
                                                            class="bx bx-log-in"></i> {{ __('Login as Seller') }}</a>
