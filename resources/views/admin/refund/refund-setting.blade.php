            ...
            <div class="col-md-9 col-sm middle">
                <div class="card" id="settings-card">
                        ...
                        <div class="col-md-10 middle card-body">
                            ...
                            <form action="{{ route('refund.setting.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                            @endif
                            ...
                            <div class="form-group">
                                <label for="refund_request_time" class="form-control-label">{{ __('Set Time for sending Refund Request') }}<small>{{ __('(Day)') }}</small></label>
                                <input type="number" name="refund_request_time" placeholder="{{ __('Enter Refund Request Time') }}" value="{{ settingHelper('refund_request_time') }}" class="form-control" id="refund_request_time">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="file" id="refund-sticker" class="custom-file-input image_pick file-select"  accept="image/*" data-image-for="profile" name="refund_sticker" id="customFile"/>
                                ...
                                <div>
                                    @if(@$refund_sticker !=[] && is_file_exists($refund_sticker['image_72x72'] , $refund_sticker['storage']))
                                        <img src="{{ static_asset($refund_sticker['image_72x72']), $refund_sticker['storage']}}" alt="" id="img_profile" class="img-thumbnail site-icon">
                                    @else
                                        <img src="{{ static_asset('images/default/default-image-72x72.png') }}" alt="refund-sticker" id="img_profile" class="img-thumbnail site-icon ">
                                    @endif
                                </div>
                            </div>
                            @if(hasPermission('refund_setting_update'))
                        ...
                        <div class="col-md-10 middle card-body">
                            ...
                            @if(hasPermission('refund_setting_update'))
                                <form action="{{ route('refund.setting.update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label for="refund_protection_title" class="form-control-label">{{ __('Refund Protection Title') }}</label>
                                        <input type="text" name="refund_protection_title" placeholder="{{ __('Enter title') }}" value="{{ settingHelper('refund_protection_title', $lang) }}" class="form-control" id="refund_protection_title">
                                    ...
                                    <div class="form-group">
                                        <label for="refund_protection_sub_title" class="form-control-label">{{ __('Refund Protection Sub-title') }}</label>
                                        <input type="text" name="refund_protection_sub_title" placeholder="{{ __('Enter sub-title') }}" value="{{ settingHelper('refund_protection_sub_title', $lang) }}" class="form-control" id="refund_protection_sub_title">
