<div class="modal">
    <div class="menu-item" data-id="1">
        ...
        <input type="number" class="form-control mb-2 mr-sm-2 wholesale_min_qty" name="min_qty[]" value="" id="label" min="0" placeholder="{{__('Minimum QTY')}}">
        <input type="number" class="form-control mb-2 mr-sm-2 wholesale_max_qty" name="max_qty[]" value="" id="label" min="0" placeholder="{{__('Maximum QTY')}}">
