                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="price"
                                                   value="{{ old('price') != '' ? old('price') : $product_language->product->price }}"
                                        ...
                                        <div class="form-inline">
                                            <div class="drag-brop-menu" id="drag-brop-menu">
                                                ...
                                                @if(old('wholesaleprice') || count($wholesalePrices) != 0)
                                                    @foreach(old('wholesaleprice') ?? $wholesalePrices as $key => $wholesale)
                                                        @php
                                                            $old_min_qty = old('min_qty')[$key] ?? $wholesale->min_qty;
                                                            $old_max_qty = old('max_qty')[$key] ?? $wholesale->max_qty;
                                                            $price = old('wholesaleprice')[$key] ?? $wholesale->price;
                                                        @endphp
                                                        <div class="menu-item" data-id="1">
                                                            <input type="hidden" class="" name="is_wholesale" value="1">
                                                            <input type="number" class="form-control mb-2 mr-sm-2 wholesale_min_qty" name="min_qty[]" value="{{ @$old_min_qty }}" id="label" min="0" placeholder="{{__('Minimum QTY')}}">
                                                            <input type="number" class="form-control mb-2 mr-sm-2 wholesale_max_qty" name="max_qty[]" value="{{ @$old_max_qty }}" id="label" min="0" placeholder="{{__('Maximum QTY')}}">
                                            ...
                                            <div
                                                ...
                                                <div class="form-group mt-2">
                                                    ...
                                                    <input type="number" name="shipping_fee"
                                                           value="{{ old('shipping_fee') != '' ? old('shipping_fee') : $product_language->product->shipping_fee }}"
