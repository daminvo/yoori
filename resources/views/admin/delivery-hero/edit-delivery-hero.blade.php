    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Update Delivery Heroes') }}</h2>
                </div>
            </div>
            <div class="row">
                            ...
                            <form action="{{ route('delivery.hero.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="phone" id="phone" value="{{ old('phone') ? old('phone') : (isDemoServer() && isset($user->phone) ? Str::of($user->phone)->mask('*', 0, strlen($user->phone)-3) : $user->phone) }}"
                                               placeholder="{{__('Enter Phone No')}}" class="form-control" required>
                                        @if ($errors->has('phone'))
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" step=".01" name="salary" id="salary"
                                               ...
                                               value="{{ old('salary') ? old('salary') : @$user->deliveryHero->salary }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" step=".01" name="commission" id="commission"
                                               ...
                                               value="{{ old('commission') ? old('commission') : @$user->deliveryHero->commission }}"
