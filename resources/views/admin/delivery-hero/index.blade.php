    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Delivery Heroes Lists') }}</h2>
                ...
                @if(hasPermission('delivery_hero_create'))
                    <div class="buttons add-button">
                        <a href="{{ route('delivery.hero.create') }}" class="btn btn-icon icon-left btn-outline-primary">
                            <i class="bx bx-plus"></i>{{ __('Add New Delivery Hero') }}</a>
                    </div>
                @endif
            </div>
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ format_price($value->balance) }}</td>
                                        <td>{{ $value->deliveryHero ? format_price($value->deliveryHero->total_collection) : 0}}</td>
                                        <td>{{ $value->deliveryHero ? format_price($value->deliveryHero->total_commission) : 0}}</td>
                                        <td>
                                                     ...
                                                     @if($value->is_user_banned == 0)
                                                         <a href="{{ route('user.ban', $value->id) }}"
                                                            class="dropdown-item has-icon"><i
                                                                 class='bx bx-lock'></i>{{ __('Ban This Delivery Hero') }}</a>

                                                     @else
                                                         <a href="{{ route('user.ban', $value->id) }}"
                                                            class="dropdown-item has-icon"><i
                                                                 class='bx bx-lock-open'></i>{{ __('Unban This Delivery Hero') }}
                                                         </a>
                                                     @endif
                                                 @endif
