                        ...
                        <div class="card-body col-md-10 middle">
                            ...
                            <form method="post" action="{{route('update')}}">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group">
                                        <label for="name">{{ __('Seller Registration Agreement') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="name">{{ __('Customer Registration Agreement') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="name">{{ __('Privacy Agreement') }}</label>
                                    ...
                                    @if(addon_is_activated('refund'))
                                        <div class="form-group">
                                            <label for="refund_policy_agreement">{{ __('Refund Policy Agreement') }}</label>
