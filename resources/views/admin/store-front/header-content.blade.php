                            ...
                            <div class="card">
                                ...
                                <div class="card-body col-md-10 middle">
                                    <form method="post" action="{{route('update')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="light_logo">{{ __('Logo Light') }} {{__('(100X38)')}}</label>
                                            <div class="form-group">
                                            ...
                                            <div>
                                                @if(@settingHelper('light_logo') != [] && is_file_exists(@settingHelper('light_logo')['image_72x72']))
                                                    <img src="{{ static_asset(@settingHelper('light_logo')['image_72x72'])}}" alt="" id="img_light_logo" class="img-thumbnail site-icon" />
                                                @else
                                        ...
                                        <div class="form-group seo-image-positoin">
                                            <label for="dark_logo">{{ __('Logo Dark') }} {{__('(100X38)')}}</label>
                                            <div class="form-group">
                                            ...
                                            <div>
                                                @if(@settingHelper('dark_logo') != [] && is_file_exists(@settingHelper('dark_logo')['image_72x72']))
                                                    <img src="{{ static_asset(@settingHelper('dark_logo')['image_72x72'])}}" alt="" id="img_dark_logo" class="img-thumbnail site-icon" />
                                                @else
