                                            ...
                                            <div class="col-md-10">
                                                    ...
                                                    <div class="row mt-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    @php
                                                                        $action_type = 'product';
                                                                    @endphp
                                                                    <select class="form-control selectric action_type" data-count="{{ $content_count }}" name="action_type_{{ $content_count }}[]">
                                                                        <option value="product" {{ isset($banner_contetns['action_type'][$key]) && $banner_contetns['action_type'][$key] == 'product' ? 'selected' : '' }}>{{__('Product')}}</option>
                                                                        <option value="category" {{ isset($banner_contetns['action_type'][$key]) && $banner_contetns['action_type'][$key] == 'category' ? 'selected' : '' }}>{{__('Category')}}</option>
                                                                        <option value="brand" {{ isset($banner_contetns['action_type'][$key]) && $banner_contetns['action_type'][$key] == 'brand' ? 'selected' : '' }}>{{__('Brand')}}</option>
                                                                        @if(settingHelper('seller_system') == 1)
                                                                            <option value="seller" {{ isset($banner_contetns['action_type'][$key]) && $banner_contetns['action_type'][$key] == 'seller' ? 'selected' : '' }}>{{__('Seller')}}</option>
                                                                        @endif
                                                                        <option value="blog" {{ isset($banner_contetns['action_type'][$key]) && $banner_contetns['action_type'][$key] == 'blog' ? 'selected' : '' }}>{{__('Blog')}}</option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="productDiv" id="product_{{ $content_count }}"
                                                                 style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'product_id_'.$content_count ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label for="product_id">{{ __('Action To') }}</label>
                                                                    <select class="product-by-ajax_{{ $content_count }} product-by-ajax form-control select2" id="product_id_{{ $content_count }}"
                                                                            name="product_id_{{ $content_count }}[]" aria-hidden="true">
                                                            ...
                                                            <div class="categoryDiv" id="category_{{ $content_count }}" style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'category_id_'.$content_count ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label for="category">{{ __('Action To') }}</label>
                                                                    <select class="filter-categories-by-ajax_{{ $content_count }} form-control"
                                                                            name="category_id_{{ $content_count }}[]" aria-hidden="true" id="category_id_{{ $content_count }}">
                                                                        <option value="">{{ __('Category') }}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="blogDiv" id="blog_{{ $content_count }}" style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'blog_id_'.$content_count ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label for="blog">{{ __('Action To') }}</label>
                                                                    <select class="filter-blogs-by-ajax_{{ $content_count }} form-control" name="blog_id_{{ $content_count }}[]"
                                                                            aria-hidden="true" id="blog_id">
                                                                        <option value="">{{ __('Blog') }}</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="brandDiv" id="brand_{{ $content_count }}" style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'brand_id_'.$content_count ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label for="brand">{{ __('Action To') }}</label>
                                                                    <select class="form-control select2" name="brand_id_{{ $content_count }}[]" id="brand_id_{{ $content_count }}">
                                                            ...
                                                            @if(settingHelper('seller_system') == 1)
                                                                <div class="sellerDiv" id="seller_{{ $content_count }}" style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'sl_'.$content_count ? '' : 'display:none' }}">
                                                                    <div class="form-group">
                                                                        <label for="brand">{{ __('Action To') }}</label>
                                                                        <select class="seller-by-ajax_{{ $content_count }} form-control select2" name="sl_{{ $content_count }}[]"
                                                                                aria-hidden="true">
                                                            ...
                                                            @endif
                                                            <div class="urlDiv" id="url_{{ $content_count }}" style="{{ isset($banner_contetns['action_to'][$key]) && $banner_contetns['action_to'][$key] == 'slider_url_'.$content_count ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label for="slider_url">{{ __('URL') }}</label>
                                                                    <input type="text" class="form-control" name="slider_url_{{ $content_count }}[]"
                                                ...
                                                @else
                                                    <input type="text" class="form-control mt-2 mr-sm-2 menu-url-input"
                                                           id="link" name="banner_url_{{ $content_count }}[]" value="{{ $banner_contetns['url'][$key] ? $banner_contetns['url'][$key] : '/' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                @php
                                                    $action_type = 'product';
                                                @endphp
                                                <select class="form-control selectric action_type" data-count="{{ $content_count }}" name="action_type_{{ $for_content }}[]">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="categoryDiv" id="category_{{ $content_count }}" style="{{ old('action_type') ? (old('action_type') == 'category' ? '' : 'display:none')
                                            ...
                                            <div class="form-group">
                                                <label for="category">{{ __('Action To') }}</label>
                                                <select class="filter-categories-by-ajax_{{ $content_count }} form-control"
                                                        name="category_id_{{ $for_content }}[]" aria-hidden="true" id="category_id_{{ $content_count }}">
                                                    <option value="">{{ __('Category') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="blogDiv" id="blog_{{ $content_count }}" style="{{ old('action_type') ? (old('action_type') == 'blog' ? '' : 'display:none')
                                            ...
                                            <div class="form-group">
                                                <label for="blog">{{ __('Action To') }}</label>
                                                <select class="filter-blogs-by-ajax_{{ $content_count }} form-control" name="blog_id_{{ $for_content }}[]"
                                                        aria-hidden="true" id="blog_id">
                                                    <option value="">{{ __('Blog') }}</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="brandDiv" id="brand_{{ $content_count }}" style="{{ old('action_type') ? (old('action_type') == 'brand' ? '' : 'display:none')
                                            ...
                                            <div class="form-group">
                                                <label for="brand">{{ __('Action To') }}</label>
                                                <select class="form-control select2" name="brand_id_{{ $for_content }}[]" id="brand_id_{{ $content_count }}">
                                                    <option value="">{{ __('Select Brand') }}</option>
                                                    @foreach($brands as $brand)
                                                        <option
                                                                value="{{ $brand->id }}" {{ $brand->id == old('brand') ? 'selected' : '' }}>{{ $brand->getTranslation('title', App::getLocale()) }}</option>
                                        ...
                                        @if(settingHelper('seller_system') == 1)
                                            <div class="sellerDiv" id="seller_{{ $content_count }}" style="{{ old('action_type') ? (old('action_type') == 'seller' ? '' : 'display:none')
                                                ...
                                                <div class="form-group">
                                                    <label for="brand">{{ __('Action To') }}</label>
                                                    <select class="seller-by-ajax_{{ $content_count }} form-control select2" name="sl_{{ $for_content }}[]"
                                                            aria-hidden="true">
                                                        <option selected value=""> {{ __('seller') }} </option>
                                                    </select>
                                                </div>
                                        ...
                                        @endif
                                        <div class="urlDiv" id="url_{{ $content_count }}" style="{{ old('action_type') ? (old('action_type') == 'url' ? '' : 'display:none')
                                                        : (isset($edit) ? ($edit->action_type == 'url' ? '': 'display:none') : 'display:none')}}">
                                            <div class="form-group">
                                                <label for="slider_url">{{ __('URL') }}</label>
                                                <input type="text" class="form-control" name="slider_url_{{ $for_content }}[]"
                                                       value="{{ isset($edit) ? $edit->link : old('url') }}"
                                                       placeholder="{{__('URL')}}">
                                                @if ($errors->has('url'))
                                                    <div class="invalid-feedback">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <select class="form-control select2" name="campaign_{{$content_count}}[]" required multiple>
                    ...
                    @php
                        ...
                        $campaigns = \App\Models\Campaign::latest()->where('status', 1)->where('status',1)->get();
                    @endphp
        ...
        <div class="menu-item card" data-id="{{  $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <select class="form-control select2 lang" name="top_category_{{ $content_count }}[]" multiple required>
                    ...
                    @foreach($categories as $key => $category)
                        <option
                                value="{{ $category->id }}" {{ @$contents ? (in_array($category->id, $contents['top_category']) ? 'selected' : '') : '' }}>{{ $category->getTranslation('title', \App::getLocale()) }}</option>
                        @foreach ($category->childCategories as $childCategory)
