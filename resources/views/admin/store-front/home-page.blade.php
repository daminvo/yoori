                        ...
                        <div class="static-content content-{{ $content_count + 1 }}" id="home-page-content">
                            <div class="menu-item card" data-id="{{  $content_count + 1 }}">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div>
                                        <select class="form-control selectric about-select-lang site-lang" name="site_lang" data-title="home_page_article" data-url="{{ route('about-description-by-lang') }}">
                                ...
                                <div class="card-body article-{{ $content_count + 1 }}">
                                    <div class="form-group">
                                        <textarea name="home_page_article" class="summernote" id="home_page_article" placeholder="{{__('About Description')}}">{{old('about_description') ? old('about_description') : settingHelper('home_page_article', App::getLocale())}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sg-builder-content text-center builder-content">
                                    ...
                                    <div class="card builder add-home-content" data-type="download_section" data-area="home-content">
                                        <div class="card-overlay">
                                            <a href="#"><i class="eicon-plus"></i></a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="card-body">
                                <div class="form-group row mt-2">
                                    <label class="custom-switch">
                                        <input type="checkbox" value="1" name="show_subscription_section" {{ settingHelper('show_subscription_section') == 1 ? 'checked' :  '' }}
                                ...
                                <div class="form-group row mt-2">
                                    <label class="custom-switch">
                                        <input type="checkbox" value="1" name="show_blog_section" {{ settingHelper('show_blog_section') == 1 ? 'checked' :  '' }}
                                        class="custom-switch-input">
                                        <span class="custom-switch-indicator"></span>
                                ...
                                <div class="form-group row mt-2">
                                    <label class="custom-switch">
                                        <input type="checkbox" value="1" name="show_service_info_section" {{ settingHelper('show_service_info_section') == 1 ? 'checked' :  '' }}
                                        class="custom-switch-input">
                                        <span class="custom-switch-indicator"></span>
                                ...
                                <div class="form-group row mt-2">
                                    <label class="custom-switch">
                                        <input type="checkbox" value="1" name="show_recent_viewed_products" {{ settingHelper('show_recent_viewed_products') == 1 ? 'checked' :  '' }}
                                        class="custom-switch-input">
                                        <span class="custom-switch-indicator"></span>
                                ...
                                <div class="form-group row mt-2">
                                    <label class="custom-switch">
                                        <input type="checkbox" value="1" name="show_categories_section" {{ settingHelper('show_categories_section') == 1 ? 'checked' :  '' }}
                                        class="custom-switch-input">
                                        <span class="custom-switch-indicator"></span>
