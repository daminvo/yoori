                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 15px 30px">
                            ...
                            <p>{{ __("Your order :code Status is :delivery_status now", ['code'=> $data['code']->code,'delivery_status' => $data['code']->delivery_status]) }}</p>
                            <a href="{{ $data['url'] }}" class="email-btn">{{ __('Details') }}</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
