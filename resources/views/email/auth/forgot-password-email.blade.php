                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align:center;padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Hi {{$data['user']->first_name .' '.$data['user']->last_name}},</p>
                                    <p style="margin-bottom: 25px;">{{__('Click on the link below to reset your password.')}}</p>
                                    <a href="{{ $data['url'] }}" class="email-btn">{{__('reset_password')}}</a>
                                </td>
                            </tr>
<!--                            <tr>
                                <td style="text-align: left">{{ $data['user']->email }}</td>
                                <td style="text-align: left">{{ $data['user']->code }}</td>
                            </tr>-->
                            <tr>
