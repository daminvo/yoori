...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-toastr-2.min.css') }}?version=130">


    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-slick-carousel.css') }}">
    <link rel="stylesheet" href="{{ static_asset('frontend/css/vue-slick-carousel-theme.css') }}">

    @if(isDemoServer())
        <link rel="stylesheet" href="{{ static_asset('frontend/css/color-switcher.css') }}">
    @endif
    ...
    <style>
        :root {
            ...
            --secondary-color: {{ settingHelper('secondary_color') }};
            ...
            --profile-sidebar: {{ settingHelper('menu_background_color').'20' }};
...
<script>
    ...
    @php
        $chat_addon = in_array('chat_messenger',$addons);
    @endphp
    @if($chat_addon)
...
<div class="fb-customerchat"
     ...
     page_id="{{ settingHelper('facebook_page_id') }}"
