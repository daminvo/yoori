                                        ...
                                        <div class="form-inline">
                                            <div class="drag-brop-menu" id="drag-brop-menu">
                                                    ...
                                                    @foreach(old('wholesaleprice') as $key => $wholesale)
                                                        ...
                                                        <div class="menu-item" data-id="1">
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   name="min_qty[]" value="{{ @$old_min_qty }}" id="label"
                                                                   min="0" placeholder="{{__('Minimum QTY')}}">
                                                            <input type="number"
                                                                   class="form-control mb-2 mr-sm-2 wholesale_max_qty"
                                                                   name="max_qty[]" value="{{ @$old_max_qty }}" id="label"
                                                                   min="0" placeholder="{{__('Maximum QTY')}}">
                                                            <input type="number"
                                                                   class="form-control mb-2 mr-sm-2 wholesale_min_price"
                                                                   id="link" name="wholesaleprice[]" value="{{ @$price }}"
                                                                   min="0" step="any" placeholder="{{__('Price per piece')}}">
                                                            @if($key > 0)
                                                                <button type="button"
                                                ...
                                                @else
                                                    <div class="menu-item" data-id="1">
                                                        <input type="hidden" class="" name="is_wholesale" value="1">
                                                        <input type="number" class="form-control mb-2 mr-sm-2 wholesale_min_qty"
                                                               name="min_qty[]" value="{{ @$old_min_qty }}" id="label" min="0"
                                                               placeholder="{{__('Minimum QTY')}}">
                                                        <input type="number" class="form-control mb-2 mr-sm-2 wholesale_max_qty"
                                                               name="max_qty[]" value="{{ @$old_max_qty }}" id="label" min="0"
                                                               placeholder="{{__('Maximum QTY')}}">
                                                        <input type="number"
                                                               class="form-control mb-2 mr-sm-2 wholesale_min_price" id="link"
                                                               name="wholesaleprice[]" value="{{ @$price }}" min="0" step="any"
