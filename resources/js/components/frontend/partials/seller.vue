            ...
            <li v-for="(shop,i) in sellers">
                <div class="sg-product">
                    ...
                    <div class="favorite-icon" v-if="authUser">
                        <a href="javascript:void(0)" :class="{ 'disable_btn' : disabled }" @click="removeFollowed(shop.id)" v-if="checkFollowed(shop)"><span
                            class="mdi mdi-name mdi-heart"></span></a>
                        <a href="javascript:void(0)" :class="{ 'disable_btn' : disabled }" @click="follow(shop.id)" v-else><span
