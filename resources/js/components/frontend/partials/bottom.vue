<template>
    <footer class="footer-section">
        <div class="footer-top">
            <div class="container">
                <div class="footer-logo">
                    <router-link :to="{ name: 'home' }"><img v-lazy="settings.footer_logo"
                                                             :alt="defaultAssets.preloader" class="img-fluid">
                    </router-link>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-md-6" v-if="settings.seller_system == 1 && !authUser" :class="[classObj()]">
                        <div class="footer-widget" v-if="!authUser && settings.seller_system == 1">
                            ...
                            <ul class="global-list">
                                ...
                                <li>
                                    <router-link :to="{ name : 'register', params:{type:'seller'}}">
                    ...
                    <div class="col-sm-6 col-md-6" :class="[classObj()]">
                        <div class="footer-widget">
                            ...
                            <ul class="global-list"
                                ...
                                <li><a target="_blank"
                                       :href="getUrl('admin/password-change')">{{ lang.change_password }}</a></li>
                            </ul>
                            <ul class="global-list" v-else-if="authUser && authUser.user_type == 'seller'">
                                ...
                                <li><a target="_blank"
                                       :href="getUrl('seller/password-change')">{{ lang.change_password }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6" :class="[classObj()]">
            ...
            <div class="container">
                <div class="footer-bottom-content">
                    ...
                    <div class="payment-card">
                        <ul class="global-list">
                            <li v-if="settings.visa_pay_banner"><img v-lazy="defaultAssets.visa"
                                                                     :alt="defaultAssets.preloader"
                                                                     class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.master_card_pay_banner"><img v-lazy="defaultAssets.master_card"
                                                                            :alt="defaultAssets.preloader"
                                                                            class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.american_express_pay_banner"><img v-lazy="defaultAssets.american_express"
                                                                                 :alt="defaultAssets.preloader"
                                                                                 class="img-fluid footer-payment-icon">
                            </li>
                            <li v-if="settings.paypal_payment_banner"><img v-lazy="defaultAssets.paypal_svg"
                                                                           :alt="defaultAssets.preloader"
                                                                           class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.apple_pay_banner"><img v-lazy="defaultAssets.apple_pay"
                                                                      :alt="defaultAssets.preloader"
                                                                      class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.amazon_pay_banner"><img v-lazy="defaultAssets.amazon_pay"
                                                                       :alt="defaultAssets.preloader"
                                                                       class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.after_pay_banner"><img v-lazy="defaultAssets.after_pay"
                                                                      :alt="defaultAssets.preloader"
                                                                      class="img-fluid footer-payment-icon"></li>
                            <li v-if="settings.payment_method_banner"><img v-lazy="settings.payment_method_banner"
                                                                           :alt="defaultAssets.preloader"
                                                                           class="img-fluid footer-payment-icon"></li>
                        </ul>
                    </div>
        ...
        <div class="yoori--cookies" v-if="checkGDPR() && gdpr">
            <div class="cookie-content" v-html="settings.gdpr">
            </div>
...
export default {
    ...
    methods: {
        ...
        classObj() {
            return [
                this.settings.seller_system == 1 && !this.authUser ? 'col-lg-2' : 'col-lg-3'
            ];
        }
    }
}
