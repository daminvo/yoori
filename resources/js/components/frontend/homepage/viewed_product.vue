<template>
    <section class="product-section pt-2" v-if="lengthCounter(this.products) > 0">
        <div class="container">
            ...
            <VueSlickCarousel class="recent-product-slider" v-bind="slick_settings" :rtl="settings.text_direction == 'rtl'">
                <div class="recent-product" v-for="(product,index) in products" :key="index">
                    <div class="product-thumb">
                        <a :href="getUrl('product/'+product.slug)" @click.prevent="routerNavigator('product.details',product.slug)"><img v-lazy="product.image_72x72" :alt="product.product_name" class="img-fluid"></a>
                    </div>
                    <div class="overlay">
