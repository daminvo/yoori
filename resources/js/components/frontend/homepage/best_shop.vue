<template>
    <section class="sg-seller-product best-shop" v-if="lengthCounter(countShop)>0">
        <div class="container">
            <div class="title">
    ...
    <section class="shop-setion" v-else-if="shimmer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4" v-for="(shop,i) in 3">
