            ...
            <div class="banner-contact">
              ...
              <form class="contact-form" name="contact-form" @submit.prevent="submit">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" v-model="contact_form.name" :placeholder="lang.name" :class="{ 'is-invalid' : errors.name }">
                </div>
                <span class="validation_error"
                      v-if="errors.name">{{ errors.name[0] }}</span>
                <div class="form-group">
                  <label>{{ lang.email }}</label>
                  <input type="email" class="form-control" v-model="contact_form.email" :placeholder="lang.email" :class="{ 'is-invalid' : errors.email }">
                </div>
                <span class="validation_error"
                      v-if="errors.email">{{ errors.email[0] }}</span>
                <div class="form-group">
                  <label>{{ lang.subject }}</label>
                  <input type="text" class="form-control" v-model="contact_form.subject" :placeholder="lang.subject" :class="{ 'is-invalid' : errors.subject }">
                </div>
                <span class="validation_error"
                      v-if="errors.subject">{{ errors.subject[0] }}</span>
                <div class="form-group">
                  <label>{{ lang.message }}</label>
                  <textarea class="form-control" v-model="contact_form.message" :placeholder="lang.write_your_message" :class="{ 'is-invalid' : errors.message }"></textarea>
                </div>
                <span class="validation_error"
                ...
                <div class="banner-contact-info" :class="{ 'banner-contact-info-center' : !shop.shop_tagline } ">
                  ...
                  <div class="feature-text text-center">
                    ...
                    <ul class="global-list d-flex">
                      <li class="pe-3">{{ lang.products }}: <span>{{ shop.total_products }}</span>
                      </li>
    ...
    <section class="sg-feature-product">
      <div class="sg-page-menu">
        <ul class="global-list">
          <li :class="{ 'active' : activeTab == 'store' }" @click="$store.commit('setActiveTab', 'store')"><a
              href="javascript:void(0)">{{ lang.store }}</a></li>
          <li v-if="settings.coupon_system == 1" :class="{ 'active' : activeTab == 'coupons' }" @click="$store.commit('setActiveTab', 'coupons')"><a
              href="javascript:void(0)">{{ lang.coupons }}</a></li>
          <li :class="{ 'active' : activeTab == 'product' }" @click="$store.commit('setActiveTab', 'product')"><a
              href="javascript:void(0)">{{ lang.all_products }}</a></li>
        </ul>
      </div>
      <div class="container" v-if="lengthCounter(productList)>0">
        <div class="header-products-description">
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" :class="{ 'active show' : activeTab == 'store' }"
                 id="store">
            ...
            <div v-if="settings.coupon_system == 1" role="tabpanel" class="tab-pane fade" id="coupons"
              ...
              <div class="row">
                <div class="col-md-4" v-for="(coupon,i) in coupons.data" :key="i">
                  <div class="coupon-text-thumb">
                    <div class="coupon-text">
                      ...
                      <p>{{ coupon.title }}</p>
                      <a href="javaScript:void(0)" @click="copyTestingCode(coupon.code)"
                         class="btn">{{lang.get_code}}</a>
                      <div class="form-group">
                        <input type="hidden" class="form-control"
                               :id="'testing-code_'+coupon.code" :value="coupon.code">
                      </div>
                    </div>
                ...
                <div class="show-more mt-4" v-if="coupons && coupons.next_page_url && !loading">
                  <a href="javascript:void(0)" @click="loadCoupon" class="btn">{{lang.show_more}}</a>
                </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="product"
                 :class="{ 'active show' : activeTab == 'product' }">
              <div class="row">
...
<!--                      <div class="accordion-item" v-if="!category_routes.includes(form.route)">
                        <div class="accordion-header" id="ac1">
                          <button class="accordion-button" @click="category = !category"
                                  :class="{ 'collapsed' :  !category }" type="button"
                        ...
                        <div id="category" class="accordion-collapse collapse"
                             :class="{ 'show' : category }" aria-labelledby="ac1">
                          <div class="accordion-body">
                            <ul class="global-list">
                              <li v-for="(category,index) in categories"  :key="'category'+index" @click="categoryAttributes(category)">
                                <router-link :to="{ name : 'product.by.category',params : { slug : category.slug } }"> {{ category.title }}
                            ...
                            <div v-if="category_load_more || categories.next_page_url"><a
                                ...
                                href="javaScript:void(0)">{{ lang.show_more }}</a></div>
                          </div>
                        </div>
                      </div>-->
                      <div class="accordion-item">
                        <div class="accordion-header" id="ac3">
                          <button class="accordion-button" @click="price = !price"
                                  :class="{ 'collapsed' : !price }" type="button"
                                  data-bs-toggle="collapse" data-bs-target="#price_collapse"
                                  aria-expanded="false" aria-controls="collapse2">{{ lang.price }}
                          </button>
                        </div>
                        <div id="price_collapse" class="accordion-collapse collapse"
                             :class="{ 'show' : price }"
                             aria-labelledby="ac3">
                          <div class="accordion-body">
                            <div class="price-top">
                              <div class="form-group">
                                <input type="text" min="0" :max="min_amount"
                                       @focusout="filterProducts" v-model="form.price.min"
                                       class="form-control"
                                       :placeholder="lang.min">
                              </div>
                              <div class="form-group">
                                <input type="text" :min="min_amount" @focusout="filterProducts"
                                       :max="max_amount" v-model="form.price.max"
                                       class="form-control"
                      ...
                      <div class="accordion-item" v-if="form.route != 'product.by.brand'">
                        <div class="accordion-header" id="ac4">
                          <button class="accordion-button" @click="brand = !brand"
                                  :class="{ 'collapsed' : !brand }" type="button"
                                  data-bs-toggle="collapse" data-bs-target="#brand_collapse"
                                  aria-expanded="false" aria-controls="brand_collapse">{{ lang.brand }}
                          </button>
                        </div>
                        <div id="brand_collapse" :class="{ 'show' : brand }"
                            ...
                            <form action="#" class="form-checkbox">
                              <div class="form-group" v-for="(brand,i) in brands.data" :key="i">
                                <input type="checkbox" :id="'brand'+brand.id"
                                       @change="filterProducts" :value="brand.id"
                                       v-model="form.brand">
                      ...
                      <div class="accordion-item" v-for="(attribute,index) in attributes"
                        ...
                        <div :id="'collapse_attribute_'+attribute.id" class="accordion-collapse collapse"
                          ...
                          <div class="accordion-body">
                            <form action="#" class="form-checkbox">
                              <div class="form-group"
                                   v-for="(value,index) in attribute.attribute_value"
                                   :key="'value'+index">
                                <input type="checkbox" :id="attribute.id+'attribute'+value.id"
                                       @change="filterProducts(attribute.id,value.id)"
                                       :value="value.id"
                      ...
                      <div class="accordion-item" v-if="settings.color == 1">
                        <div class="accordion-header" id="ac5">
                          <button class="accordion-button" @click="color = !color"
                                  :class="{ 'collapsed' : !color}" type="button"
                            ...
                            <form action="#" class="form-checkbox">
                              <div class="form-group" v-for="(color,index) in colors.data"
                                ...
                                <input type="checkbox" :id="'filter_color'+color.id"
                                       @change="filterProducts" :value="color.id"
                                       v-model="form.color">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header" id="ac6">
                          <button class="accordion-button" @click="ratting = !ratting"
                                  :class="{ 'collapsed' : !ratting }" type="button"
                                  data-bs-toggle="collapse" data-bs-target="#collapse6"
                                  aria-expanded="false" aria-controls="collapse6">{{ lang.ratting }}
                          </button>
                        </div>
                            ...
                            <form action="#" class="form-checkbox">
                              <div class="form-group">
                                <input type="checkbox" id="rating5"
                                       @change="filterProducts" value="5" v-model="form.rating">
                                <label for="rating5">
                                  <ul class="global-list">
                              ...
                              <div class="form-group">
                                <input type="checkbox" id="rating4"
                                       @change="filterProducts" value="4" v-model="form.rating">
                                <label for="rating4">
                                  <ul class="global-list">
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star-outline"></span>
                                    </li>
                                  </ul>
                                </label>
                              </div>
                              <div class="form-group">
                                <input type="checkbox" id="rating3"
                                       @change="filterProducts" value="3" v-model="form.rating">
                                <label for="rating3">
                                  <ul class="global-list">
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                              ...
                              <div class="form-group">
                                <input type="checkbox" id="rating2"
                                       @change="filterProducts" value="2" v-model="form.rating">
                                <label for="rating2">
                                  <ul class="global-list">
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                              ...
                              <div class="form-group">
                                <input type="checkbox" id="rating1"
                                       @change="filterProducts" value="1" v-model="form.rating">
                                <label for="rating1">
                                  <ul class="global-list">
                                    <li><span class="mdi mdi-name mdi-star"></span></li>
                                    <li><span class="mdi mdi-name mdi-star-outline"></span>
                ...
                <div class="col-md-8 col-lg-9">
                  <div class="sg-category-content sg-filter" :class="activeClass">
                    <div class="d-flex justify-content-between mb-4">
                      ...
                      <div class="right-content">
                        <div class="d-flex">
                          <form>
                            <div class="form-group">
                              <select v-model="form.paginate" @change="sortProducts"
                                      class="form-control">
                          ...
                          <ul class="filter-tabs global-list">
                            <li class="grid-view-tab" @click="activeClass = 'grid-view-tab'"
                                ...
                                class="mdi mdi-name mdi-grid"></span>
                            </li>
                    ...
                    <div>
                      ...
                      <div class="show-more mt-4" v-if="products && products.next_page_url && !loading">
                      ...
                      <div class="col-md-12 text-center show-more" v-show="loading">
                        <loading_button :class_name="'btn'"></loading_button>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="offers-section p-0">
          <div class="row">
            <div class="col-md-3" v-for="(attr,i) in 4">
              <a href="javascript:void(0)" class="add-banner"><shimmer :height="200"></shimmer></a>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      axios.post(url, this.contact_form)
          .then((response) => {
            this.loading = false;
