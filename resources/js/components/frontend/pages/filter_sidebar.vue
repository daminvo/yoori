                ...
                <div class="accordion-item"
                  ...
                  <div class="accordion-header" id="ac2">
                    <button class="accordion-button" @click="child_category = !child_category"
                            :class="{ 'collapsed' :  !child_category }" type="button"
                            data-bs-toggle="collapse" data-bs-target="#child_category"
          ...
          <div class="col-md-8 col-lg-9">
            <div class="sg-category-content sg-filter" :class="activeClass">
              <div class="cta mb-4" v-if="page && page.image_835x200">
                <div
                    v-if="page.image_835x200 == 'http://yoori-laravel.test/images/default/default-image-835x200.png'">
                  <a v-if="settings.category_default_banner != null"><img
                      v-lazy="settings.category_default_banner" :alt="form.slug"
                      class="img-fluid"></a>
                  <a v-else><img v-lazy="page.image_835x200" :alt="form.slug"
                                 class="img-fluid"></a>
                </div>
                <div v-else>
                  <a v-if="page.image_835x200"><img v-lazy="page.image_835x200" :alt="form.slug"
                                                    class="img-fluid"></a>
                </div>
              </div>
