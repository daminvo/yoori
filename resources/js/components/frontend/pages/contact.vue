                            ...
                            <div class="contact-info">
                                ...
                                <div class="contact-list">
                                    <ul class="global-list">
                                        <li v-if="contact.address"><span class="mdi mdi-name mdi-map-marker"></span>{{ contact.address }}</li>
                                        <li v-if="contact.phone || contact.optional_phone"><span class="mdi mdi-name mdi-phone"></span> <a :href="'tel:'+contact.phone">{{contact.phone}}</a> <a :href="'tel:'+contact.optional_phone">{{contact.optional_phone}}</a></li>
                                        <li v-if="contact.email || contact.optional_email"><span class="mdi mdi-name mdi-email"></span> <a :href="'mailto:'+contact.email">{{contact.email}}</a> <a :href="'mailto:'+contact.optional_email">{{ contact.optional_email }}</a></li>
                                    </ul>
                                </div>
                                <div class="social"
