                    ...
                    <table class="table table-bordered" >
                        ...
                        <tr>
                            ...
                            <th v-for="(product,index) in products" :key="index">
                                ...
                                <a class="compare_delete_btn" @click="removeProduct(product.id)"
                        ...
                        <tr>
                            ...
                            <td v-for="(product,index) in products" :key="'btn'+index">
                                <div class="text-center show-more">
                                    <a v-if="product.status == 'published'" href="javascript:void(0)" @click="cartBtn(product)" class="btn">{{lang.add_o_cart}}</a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
