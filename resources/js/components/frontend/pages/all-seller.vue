                ...
                <div class="col-md-12 col-lg-12">
                    <div class="sg-category-content sg-filter" :class="activeClass">
                            ...
                            <div class="right-content">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="filter-tabs global-list">
                                        <li class="grid-view-tab"  @click="activeClass = 'grid-view-tab'" :class="{'active' : activeClass == 'grid-view-tab' || activeClass == ''}">
                        ...
                        <div class="show-more mt-4">
                            <a href="javascript:void(0)" v-if="paginate && !loading" @click="loadSellers()" class="btn">{{lang.show_more}}</a>
